...
private:
    static func_t timer0CompACallback; ///< le pointeur vers la fonction de callback pour TIMER0_COMPA
    static func_t timer0CompBCallback; ///< le pointeur vers la fonction de callback pour TIMER0_COMPB
    static func_t timer0OverflowCallback; ///< le pointeur vers la fonction de callback pour TIMER0_OVF
